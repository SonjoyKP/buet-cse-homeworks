...
void LegalizeEdge(point pr,edge ed)
{
    ...
    if( pr==ed.a)//(int)pr.x==(int)ed.a.x and (int)pr.y==(int)ed.a.y
    {
        ...
        if(isIleagal(ed))
        {
            ...
            edgeList[allEdgeId[ed.s.point_id][ed.e.point_id]]=newedge;
...
int main(int argc, char **argv)
{
    ...
    double dist=sqrt((topmostRightmostPoint.x-(_left.x-5))*(topmostRightmostPoint.x-(_left.x-5))+(topmostRightmostPoint.y-(_left.y+5))*(topmostRightmostPoint.y-(_left.y+5)));
    double xx=(INF*(_left.x-5)-(INF-dist)*topmostRightmostPoint.x)/dist;
    double yy=(INF*(_left.y+5)-(INF-dist)*topmostRightmostPoint.y)/dist;
    ...
    {
        dist=sqrt((topmostRightmostPoint.x-(_right.x+5))*(topmostRightmostPoint.x-(_right.x+5))+(topmostRightmostPoint.y-(_right.y+5))*(topmostRightmostPoint.y-(_right.y+5)));
        xx=(INF*(_right.x+5)-(INF-dist)*topmostRightmostPoint.x)/dist;
        yy=(INF*(_right.y+5)-(INF-dist)*topmostRightmostPoint.y)/dist;
